...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( AuthLoginResponseModel data)?  success,TResult Function( NetworkExceptions error)?  failed,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( AuthLoginResponseModel data)  success,required TResult Function( NetworkExceptions error)  failed,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( AuthLoginResponseModel data)?  success,TResult? Function( NetworkExceptions error)?  failed,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Success() when success != null:
...
class _Success implements LoginState {
 ...
 final  AuthLoginResponseModel data;
...
@useResult
$Res call({
 AuthLoginResponseModel data
});


$AuthLoginResponseModelCopyWith<$Res> get data;
...
$AuthLoginResponseModelCopyWith<$Res> get data {
  ...
  return $AuthLoginResponseModelCopyWith<$Res>(_self.data, (value) {
